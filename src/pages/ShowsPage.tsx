          ...
          <div className="grid gap-10 lg:grid-cols-[0.75fr_1.25fr] lg:items-end" data-reveal>
            <div>
              ...
              <h1 className="mobile-safe-title font-display text-5xl leading-none sm:text-6xl md:text-8xl">
                Um arquivo vivo das apresentacoes da escola.
              </h1>
            </div>
            <p className="max-w-2xl text-lg leading-8 text-ink/62">
              Esta pagina foi pensada para registrar espetaculos ja realizados e divulgar os
              proximos eventos, fortalecendo memoria, prova social e desejo de participacao.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 pb-20 sm:px-6 md:px-8">
        <div className="container-wide">
          <div className="mb-8 flex items-center gap-3" data-reveal>
            ...
            <h2 className="font-display text-4xl leading-none">Espetaculos realizados</h2>
          </div>
        ...
        <div className="container-wide">
          <div className="mb-10 max-w-3xl" data-reveal>
            ...
            <h2 className="mobile-safe-title font-display text-4xl leading-none sm:text-5xl md:text-7xl">
              Proximos espetaculos e acoes abertas.
            </h2>
          </div>
              ...
              return (
                <article className="rounded-3xl border border-ink/10 bg-porcelain p-7 transition duration-300 hover:-translate-y-1 hover:bg-white hover:shadow-soft" data-reveal key={show.title}>
                  <div className="mb-12 flex items-start justify-between gap-4">
                    <span className="rounded-full bg-white px-3 py-1 text-xs font-black uppercase tracking-[0.12em] text-ink/54 sm:tracking-[0.16em]">
                      {show.status}
                    </span>
                    <span className="grid h-12 w-12 shrink-0 place-items-center rounded-2xl bg-wine text-white">
